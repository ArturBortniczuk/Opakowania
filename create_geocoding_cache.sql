...
-- 3. Podłączenie Triggera pod tabelę drums
DROP TRIGGER IF EXISTS trg_sync_drum_coordinates ON public.drums;
CREATE TRIGGER trg_sync_drum_coordinates
