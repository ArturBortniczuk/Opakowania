  ...
  return (
    ...
    >
      <div 
        ...
        style={{ transformStyle: 'preserve-3d', transform: isFlipped ? 'rotateY(180deg)' : 'rotateY(0deg)', minHeight: '580px' }}
      >
        {/* FRONT */}
        <div 
        ...
        <div className="mb-8 relative z-50">
          ...
          <div className="bg-white/80 backdrop-blur-lg rounded-xl p-6 shadow-lg border border-gray-200 relative z-20">
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <div className="relative min-w-[240px]" ref={paymentDropdownRef}>
                <button
                  type="button"
